...
(() => {
  const DICT = {
    en: {
      ...
      exportConfig: "Export",
      importConfig: "Import",
      importInvalid: "This file is not a valid QuickLinks backup.",
      confirmImport: "Import this backup? It replaces your current sections, shortcuts and settings.",
      close: "Close",
      save: "Save",
      cancel: "Cancel",
      delete: "Delete",
      ...
      collapseAll: "Collapse all subsections",
      expandAll: "Expand all subsections",
    ...
    "pt-br": {
      ...
      importInvalid: "Este arquivo não é um backup válido do QuickLinks.",
      confirmImport: "Importar este backup? Ele substitui suas seções, atalhos e configurações atuais.",
      close: "Fechar",
      save: "Salvar",
      cancel: "Cancelar",
      delete: "Excluir",
      ...
      collapseAll: "Recolher todas as subseções",
      expandAll: "Expandir todas as subseções",
    ...
    es: {
      ...
      exportConfig: "Exportar",
      importConfig: "Importar",
      importInvalid: "Este archivo no es una copia de seguridad válida de QuickLinks.",
      confirmImport: "¿Importar esta copia? Reemplaza tus secciones, accesos directos y configuración actuales.",
      close: "Cerrar",
      save: "Guardar",
      cancel: "Cancelar",
      delete: "Eliminar",
      ...
      collapseAll: "Contraer todas las subsecciones",
      expandAll: "Expandir todas las subsecciones",
